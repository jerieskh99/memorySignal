...
def build_modules() -> dict:
    ...
    M = [
        ...
        mod("collapse", "divide", "Collapse pages", "S",
            ...
            params=[sel("unchanged", "unchanged pages", [["zero", "count as zero (matches K/N)"], ["excluded", "excluded from statistics"]], "zero")]),
        ...
        mod("cepstrum", "lens", "Cepstrum", "c", "peak quefrency and ceps_peak_snr_db", spectral=True,
